...
import { isCustomResponseCodeError, isNotFoundError } from "../../client/components/not-found";
 ...
 */ export function createErrorHandler({ /**
   ...
   */ _source , dev , isNextExport , errorLogger , capturedErrors , allCapturedErrors  }) {
    return (err)=>{
        ...
        if (err && (err.digest === DYNAMIC_ERROR_CODE || isNotFoundError(err) || err.digest === NEXT_DYNAMIC_NO_SSR_CODE || isRedirectError(err) || isCustomResponseCodeError(err))) {
            return err.digest;
        }
